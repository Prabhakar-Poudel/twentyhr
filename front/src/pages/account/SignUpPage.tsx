...
const SignUpPage = () => {
	...
	const onSignUp: FormEventHandler<HTMLDivElement> = async (e) => {
		...
		try {
			...
			toast({ message: Object.entries(data.errors)[0].join(' ') || 'Something went wrong, please try again', type: 'error' })
		}
	}
			...
			<Container className="!grid place-content-center">
				<Box component="section">
					...
					<Box component="form" className="mt-2" onSubmit={onSignUp}>
						...
						<Button type="submit" variant="contained" fullWidth>Sign me up</Button>
					</Box>
				</Box>
			</Container>
			<Container>
